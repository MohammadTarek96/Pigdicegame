...
from player import BotPlayer, Player, LowRiskStrategy
...
class TestGame(unittest.TestCase):
    ...
    def test_adding_new_player(self):
        """Tests the functionality of adding a new player to the list of players, by checking the list length
        and the return type"""
        game = Game()
        # check that the game's player list is empty at the beginning
    ...
    def test_adding_new_player_beyond_limit(self):
        ...
        # adding more than 4 players will throw an error
...
2) bot-1: 30"""
    ...
    def test_roll_for_current_player(self):
        ...
        # check that the roll is counted, but not to the total score
    ...
    def test_check_if_game_ended_one_player(self):
        ...
        # assert that the game did not do an end of game simulation
